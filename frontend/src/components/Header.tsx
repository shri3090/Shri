...
import { VernacularSwitcher } from './VernacularSwitcher';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          >
            ...
            <span className="text-neutral-500">{t.deliverTo}:</span>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              ...
              <span className="hidden sm:inline">{t.prdSpecs}</span>
            </button>

            {/* Phase 4: Vernacular Language Switcher */}
            <VernacularSwitcher />
