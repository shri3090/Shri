...
export default function App() {
  ...
  // Category filter
  const categories = [
    { id: 'all', label: 'All Generic Medicines' },
    { id: 'chronic', label: 'Chronic Care' },
    { id: 'diabetes', label: 'Diabetes' },
    { id: 'hypertension', label: 'Heart & Blood Pressure' },
    { id: 'pain', label: 'Pain & Fever' },
    { id: 'acidity', label: 'Acidity & GERD' },
    { id: 'antibiotics', label: 'Antibiotics' },
    { id: 'allergy', label: 'Allergy & Asthma' },
  ];
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-emerald-800 to-teal-900 text-white rounded-2xl p-6 sm:p-8 shadow-sm relative overflow-hidden">
                  <div className="relative z-10 max-w-3xl space-y-3">
                    <div className="inline-flex items-center gap-2 bg-emerald-700/60 border border-emerald-500/40 px-3 py-1 rounded-full text-xs font-semibold text-emerald-200">
                      ...
                      <span>Zero Markups • Indian Pharmacopoeia (IP) Certified</span>
                    </div>

                    <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight">
                      Compare Verified Generic Medicine Prices Across Licensed Chemists
                    </h1>

                    <p className="text-xs sm:text-sm text-emerald-100/90 leading-relaxed">
                      Save up to <strong>85%</strong> on chronic and acute medications. Generic formulations contain the exact same active molecules as expensive branded counterparts, delivered with cold-chain compliance.
                    </p>
                    ...
                    <div className="pt-2 flex flex-wrap items-center gap-3">
                      ...
                      >
                        ...
                        <span>Upload Prescription (Instant AI Matching)</span>
                      </button>
                      ...
                      >
                        <span>How Pricing Transparency Works</span>
                ...
                <div className="bg-white rounded-2xl border border-neutral-200 p-4 shadow-xs space-y-3">
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      placeholder="Search by Brand (e.g. 'Dolo 650', 'Glycomet', 'Augmentin') or Active Salt ('Paracetamol', 'Metformin', 'Telmisartan')..."
                  ...
                  {searchQuery.trim().length > 0 && (
                    <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-xl text-xs text-emerald-900 flex items-center justify-between gap-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          <strong>Bio-Equivalence Engine:</strong> Matching <em>"{searchQuery}"</em> to certified generic Indian Pharmacopoeia equivalents with identical dosage, strength, and clinical efficacy.
                        </span>
                      </div>
                      <span className="font-semibold text-emerald-800 text-[11px] shrink-0 bg-white px-2 py-0.5 rounded border border-emerald-200">
                        Average 75% Lower Cost
                      </span>
                    </div>
                  )}
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-xs text-neutral-500 px-1">
                    <span>Showing <strong>{filteredMedicines.length}</strong> bio-equivalent medicines</span>
                    <span>Sorted by: <strong>Lowest Verified Total Cost</strong></span>
                  </div>
